...
if(isset($_POST['tempValues']))
{
	...
	if ($plan == 4) {
      ...
      $plan_duration = '6 Months';
		...
		$sqlQueryupdate = "UPDATE users SET status = 'Verified', plan_start = '".$current_date."', plan_expire = '".$end_date."' WHERE userid = '".$arrval."' ";
						...
						<table border="1" width="100%" style="border-left:0;border-right:0;">
							<tr>
							 ...
							 <tr>
							  ...
							  <td align="center">'.$plantable["plan_name"].'</td>
...
$canvas->text($x, $y, $text, $font, 75); 
	...
	$i++;		
	 ...
	 echo "<script> window.location.href = 'awaiting_approval.php?msg=Y';</script>";
        ...
        <div class="col-md-12">
          <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
            <ul class="nav nav-tabs tab-transparent" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="awaiting_approval.php" role="tab" aria-selected="false">Approvals</a>
              </li>
          ...
          <div class="tab-content tab-transparent-content">
            ...
            <div class="tab-pane fade show  <?php if(!isset($_GET["err"])){?>active <?php } ?>" id="approvals" role="tabpanel" aria-labelledby="business-tab">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title" style="margin-bottom: 8px;">Awaiting for Approvals</h4>
                  <div class="row">
                    <div class="col-12">
					...
					<?php } ?>
                      ...
                      <div style="min-height:500px;">
                        ...
                        <table id="order-listing1" class="table" style="" border="1">
                          <thead>
                              <tr><td colspan="16" align="right"><input type="submit" name="add" id="add" class="btn btn-info" style="padding: 15px 32px;" value="Approve" onclick="myFunctionapprove()" ></td></tr>
                            <tr>
                          ...
                          <tbody>
                                ...
                                <?php $plantable=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM `plan_details` WHERE id = '".$row['plan_id']."' ")); ?>															  
								  ...
								  <td><?php if($row['plan_id'] == 1) { echo "Free"; } else {echo "Not Paid";} ?></td>
