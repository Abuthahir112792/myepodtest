...
$result = mysqli_query($con,$sql); 
	...
	while( $row = mysqli_fetch_array($result)){ 
		...
		if($row["plan_end"] == $expairy_date3){
			...
			$sqlQueryupdate = "UPDATE subscription SET threeday_email_reminder = '1' WHERE plan_id  = '".$row["plan_id"]."' ";
			...
			$clientbody .= "<tr style='background: #eee;'><td colspan='2' align='center'><strong>Your Account will Expaired with in 3 Days!</strong></td></tr>";
			$clientbody .= "<tr style='background: #eee;'><td colspan='2' align='center'><strong>Account Credentials:</strong></td></tr>";
			$clientbody .= "<tr><td><strong>Plan:</strong> </td><td>" . $usertab["plan_name"] . "</td></tr>";
			$clientbody .= "<tr><td><strong>Expiary Date:</strong> </td><td>" . $row["plan_end"] . "</td></tr>";
			$clientbody .= "</table>";
