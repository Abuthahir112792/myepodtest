...
$response .='<table border="1" width="100%">
 ...
 $response .='<table border="1" width="100%">
                <tr><td><b>Status</b></td><td><b>Plan Name</b></td><td><b>Plan Date</b></td><td><b>Download</b></td></tr>';
				...
				$response .='<tr style="color:#000"><td>'.$row2["status"].'</td><td>'.$plantable["plan_name"].'</td><td>'.date("d-m-Y",strtotime($row2['plan_start'])).'<br> ----to---- <br>'.date("d-m-Y",strtotime($row2['plan_end'])).'</td><td><a href='.$url.'>'.$row2['invoiceno'].'</a></td></tr>';
