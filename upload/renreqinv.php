...
if(isset($_GET['mid'])){
	...
	$current_date = $mailtable["plan_end"];
	...
	plan_start = '".$current_date."' AND plan_end = '".$end_date."' AND plan_id= '".$plan."' AND status = 'Renewal Request Email' AND type= 'Invoice'"));	
	...
	if($dupQry1 == 0){
		...
		plan_id= '".$plan."', email = '".$email."', status = 'Renewal Request Email' , type= 'Invoice' , invoiceno = '".$invoiceno."'  ";
