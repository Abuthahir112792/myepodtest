...
if(isset($_GET['mid'])) {	
   ...
   $sessname = $usertab['company_name'];
	...
	$adminmessage .= "<tr style='background: #eee;'><td><strong>Register Type:</strong> </td><td>" . strip_tags($usertab['identification_type']) . "</td></tr>";
	...
	$adminmessage .= "<tr style='background: #eee;'><td><strong>Contact:</strong> </td><td>" . $usertab['mobile'] . "</td></tr>";
